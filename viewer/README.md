...
The live/history UI is built from the same Station page template used by `station_edition/xrs/web_server.py`. Viewer-specific code only patches the data/API layer and removes Station-only controls from the DOM.
