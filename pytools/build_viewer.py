#!/usr/bin/env python3
"""Build helper for the standalone XRS node-center viewer."""
...
def build_binary(target: str, *, clean: bool = True, release_tag: str = "", build_commit: str = "") -> Path:
    ...
    cmd = [
        ...
        "--clean",
        "--add-data",
        data_arg("station_edition/xrs/assets", "station_edition/xrs/assets"),
        "--add-data",
        data_arg("station_edition/xrs/web_server.py", "station_edition/xrs"),
        "--add-data",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the XRS node-center viewer binary")
