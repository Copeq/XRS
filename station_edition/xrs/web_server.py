...
.simulation-modal{position:fixed;bottom:24px;right:24px;z-index:12000;display:none;padding:0;background:transparent;box-shadow:none}
.simulation-modal.show{display:block}
.simulation-card{width:min(380px,92vw);max-height:min(70vh,560px);overflow:auto;border:1px solid var(--border);border-radius:18px;background:var(--panel);box-shadow:var(--shadow-lg)}
